...
- [x] Honest STEM supply: Causey now stages published U.S. Department of Energy National Science Bowl national-event dates from ordinary public pages permitted by `robots.txt`; Office of Science public-domain attribution and no-endorsement limits are explicit, direct registration stays empty because qualification is regional, and blocked/restricted STEM directories remain links only — 2026-08-12
...
- [x] Multi-category organization coordination: schools, districts, clubs, and teams can create chess, STEM, debate, arts, writing, or custom competitions; districts choose district-wide vs connected-school hosts; divisions remain editable; online events do not require a physical location; every org workspace has a filterable Competitions inventory; authorized org chess events join chess search with semantic gold provenance treatment while public non-chess directories remain gated — 2026-08-11
