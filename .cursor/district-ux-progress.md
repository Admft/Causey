...
- Platform admin user access (2026-08-07): `/admin/users` now provides paginated account search by display name/email plus confirmed, audited account-role, coach-tool, and platform-admin changes. Email remains behind an admin-checked RPC; self-access and last-admin removal are blocked.
