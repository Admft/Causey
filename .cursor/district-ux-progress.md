...
- [x] District pitch wording (copy only, layout untouched): home band and `/districts` say what the pilot does in plain language — “Finding the tournament is the easy part”, setup gates as “You sign the pilot terms / You name the schools / Your administrators claim access”, stages as “We set up your schools / Staff invite their own people / Coaches run the events / The district sees the totals”. Provisioning jargon (“provision and verify”, “aggregate reporting”, “staff handoff”, “scoped events”) is gone — 2026-08-09
