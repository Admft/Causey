...
| Import Chess-Results standings or science-fair ranks | Listings adapters are metadata-only by design. |

If a club owner would still need the job, log it in `.cursor/club-readiness.md` as **Out** or **Later**, with a truthful workaround (e.g. “record place by hand after Chess-Results”).
