-- Official public UIL invitational speech/debate calendar rows.
...
values (
  'uil_speech_debate_scrape',
  'UIL Speech & Debate Invitationals',
  'https://www.uiltexas.org/academics/invitational-meets-test',
  '/sources/state-affiliates.svg',
  'Official UIL invitational calendar rows that explicitly publish speech or debate offerings, exact dates, and complete Texas locations.',
  'live',
  'debate'
)
